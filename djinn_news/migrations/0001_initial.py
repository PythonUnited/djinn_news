    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('changed_by', models.ForeignKey(related_name='news_changed_by', to=settings.AUTH_USER_MODEL, on_delete=models.CASCADE)),
                ('creator', models.ForeignKey(related_name='news_creator', to=settings.AUTH_USER_MODEL, on_delete=models.CASCADE)),
